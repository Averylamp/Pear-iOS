...
//import MapKit
//
//class OldFullProfileDisplayData: Equatable {
//
//  var userID: String?
...
//  }
//
//  convenience init (matchingUser: PearUser) {
//    var interests: [String] = []
//    var vibes: [String] = []
...
//  }
//
//  static func == (lhs: OldFullProfileDisplayData, rhs: OldFullProfileDisplayData) -> Bool {
...
//  }
//
//  static func compareListsForNewItems(oldList: [OldFullProfileDisplayData], newList: [OldFullProfileDisplayData]) -> Bool {
//    var newItems = false
