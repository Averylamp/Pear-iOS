...
class FullProfileViewController: UIViewController {
  ...
  class func instantiate(profileData: ProfileData) -> FullProfileViewController? {
    ...
    guard let fullProfileVC = storyboard.instantiateInitialViewController() as? FullProfileViewController else { return nil }
    fullProfileVC.profileData = profileData
    return fullProfileVC
  }
