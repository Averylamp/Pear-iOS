...
class SummaryProfileViewController: UIViewController {
    ...
    class func instantiate(profileData: ProfileData) -> SummaryProfileViewController {
        ...
        let vc = storyboard.instantiateInitialViewController() as! SummaryProfileViewController
...
extension SummaryProfileViewController{
    ...
    func addProfileImageVC(){
        let profileImageVC = ProfileImageViewController.instantiate(images: [self.profileData.images.first!])
    ...
    func addDoDontVC(){
        let profileDoDontVC = ProfileDoDontViewController.instantiate(doStrings: [self.profileData.doList.first!], dontStrings: [self.profileData.dontList.first!])
